...
public class ComponentActivity extends Activity implements LifecycleOwner, KeyEventDispatcher.Component {
    ...
    private static boolean shouldSkipDump(String[] strArr) {
        ...
        if (iHashCode != -645125871) {
            if (iHashCode != 1159329357) {
                if (iHashCode == 1455016274 && str.equals("--autofill")) {
                    b = 0;
                }
        ...
        return b != 0 ? b != 1 ? b == 2 && Build.VERSION.SDK_INT >= 31 : Build.VERSION.SDK_INT >= 29 : Build.VERSION.SDK_INT >= 26;
    }
}
