...
public class ActivityCompat extends ContextCompat {
    ...
    public static void recreate(final Activity activity) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            new Handler(activity.getMainLooper()).post(new Runnable() { // from class: androidx.core.app.-$$Lambda$ActivityCompat$G-udpRMU-TovoJgOXpoxp7wRM9k
                @Override // java.lang.Runnable
    ...
    static class SharedElementCallback21Impl extends android.app.SharedElementCallback {
        ...
        public void onSharedElementsArrived(List<String> list, List<View> list2, final SharedElementCallback.OnSharedElementsReadyListener onSharedElementsReadyListener) {
            this.mCallback.onSharedElementsArrived(list, list2, new SharedElementCallback.OnSharedElementsReadyListener() { // from class: androidx.core.app.-$$Lambda$ActivityCompat$SharedElementCallback21Impl$UQYxTVUGBXZA2YdDvfsJsu7Oz1c
