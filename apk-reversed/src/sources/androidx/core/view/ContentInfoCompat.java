...
public final class ContentInfoCompat {
    ...
    private static final class Api31Impl {
        ...
        public static Pair<ContentInfo, ContentInfo> partition(ContentInfo contentInfo, final java.util.function.Predicate<ClipData.Item> predicate) {
            ...
            Pair<ClipData, ClipData> pairPartition = ContentInfoCompat.partition(clip, (Predicate<ClipData.Item>) new Predicate() { // from class: androidx.core.view.-$$Lambda$XrfWLNshFjqvbbSRgsJvpJ24Dt4
