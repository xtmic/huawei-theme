...
public final class WindowInsetsControllerCompat {
    ...
    static class Impl20 extends Impl {
        ...
        private void showForType(int i) {
            ...
            viewFindViewById.post(new Runnable() { // from class: androidx.core.view.-$$Lambda$WindowInsetsControllerCompat$Impl20$qhyADWO_CFF4vRk22qKKqIwKE5w
    ...
    static class Impl30 extends Impl {
        ...
        void addOnControllableInsetsChangedListener(final OnControllableInsetsChangedListener onControllableInsetsChangedListener) {
            ...
            WindowInsetsController.OnControllableInsetsChangedListener onControllableInsetsChangedListener2 = new WindowInsetsController.OnControllableInsetsChangedListener() { // from class: androidx.core.view.-$$Lambda$WindowInsetsControllerCompat$Impl30$oKBvVpyFEOnuZsGBM7OehsFMV5w
                @Override // android.view.WindowInsetsController.OnControllableInsetsChangedListener
                public final void onControllableInsetsChanged(WindowInsetsController windowInsetsController, int i) {
                    this.f$0.lambda$addOnControllableInsetsChangedListener$0$WindowInsetsControllerCompat$Impl30(onControllableInsetsChangedListener, windowInsetsController, i);
                }
            };
